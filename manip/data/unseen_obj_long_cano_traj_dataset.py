...
class UnseenCanoObjectTrajDataset(Dataset):
    def __init__(
        ...
        self.rest_object_geo_folder = os.environ.get(
            "UNSEEN_OBJECT_GEO_DIR",
            os.path.join(self.data_root_folder, "unseen_objects_data", "selected_rotated_zeroed_obj_files"),
        )
